...
# Set the number of days before password expiration to send the reminder email
$daysBeforeExpiration = 8

# Set the OUs to search for users
...
# Get the maximum password age for the domain
$maxPasswordAge = (Get-ADDefaultDomainPasswordPolicy).MaxPasswordAge

foreach ($ou in $ous) {
    # Get all users in the current OU
#    $users = Get-ADUser -SearchBase $ou -Filter * -Properties PasswordLastSet, EmailAddress
    $users = Get-ADUser -SearchBase $ou -Filter 'Enabled -eq $true' -Properties PasswordLastSet, EmailAddress, PasswordExpired | Where-Object { $_.PasswordExpired -eq $false }
    foreach ($user in $users) {
        # Calculate the user's password expiration date
        $passwordExpirationDate = $user.PasswordLastSet + $maxPasswordAge

        # Calculate the number of days until the password expires
        $daysUntilExpiration = New-TimeSpan -Start (Get-Date) -End $passwordExpirationDate | Select-Object -ExpandProperty Days

        # Check if the number of days until expiration is equal to or less than the specified number of days before expiration
        if ($daysUntilExpiration -le $daysBeforeExpiration) {
            # Create the email body using a simple HTML template
            $emailBody = @"
...
<tr>
<td align="center" style="padding:0;Margin:0;font-size:0px"><img class="adapt-img" src="https://exemple.com/images/logo.png" alt="" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none" width="180"></td>
</tr>
</table></td>
</tr>
...
<table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
<tr>
<td align="left" class="es-m-txt-c" style="padding:0;Margin:0"><h1 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:30px;font-style:normal;font-weight:normal;line-height:36px;color:#333333">Password Expiration Reminder</h1></td>
</tr>
<tr>
<td align="left" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:10px;padding-top:10px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:27px;letter-spacing:0;color:#999999;font-size:18px">Your password will expire in $daysUntilExpiration day(s). Please change your password as soon as possible.&nbsp;Follow the password recommendation guide from the <a target="_blank" style="mso-line-height-rule:exactly;text-decoration:none;color:#2CB543;font-size:18px" href="YOURURLHOWTOCHANGEPASSWORD"> tutorial</a></p></td>
</tr>
</table></td>
</tr>
</table></td>
...
<table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px">
<tr>
<td align="left" style="padding:0;Margin:0;padding-top:20px;padding-right:20px;padding-left:20px;background-position:center top">
<table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
<tr>
<td align="center" valign="top" style="padding:0;Margin:0;width:560px">
<table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
<tr>
<td align="left" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:10px"><h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:30px;font-style:normal;font-weight:normal;line-height:26px;color:#333333;text-align:center">Check the operation of the change with a reboot.</h1></td>
</tr>
<tr>
<td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:20px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:27px;letter-spacing:0;color:#999999;font-size:18px">+33 01 50 80 50 80 (call only for emergency)</p></td>
</tr>
</table></td>
</tr>
</table></td>
...
<table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
<tr>
<td class="es-m-txt-c" align="center" style="padding:0;Margin:0;padding-top:10px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">This is an automatic email please do not return.</p></td>
</tr>
</table></td>
</tr>
</table></td>
...
"@
            ...
            # Send the reminder email using the generated HTML body
            Send-MailMessage -To $user.EmailAddress -From $emailSender -Subject "Password Expiration Reminder" -Body $emailBody -BodyAsHtml -SmtpServer $smtpServer -Port $smtpPort
        }
    }
}
